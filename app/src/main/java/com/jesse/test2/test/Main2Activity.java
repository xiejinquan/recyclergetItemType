...
public class Main2Activity extends AppCompatActivity {
    ...
    private void iniRecyclerview() {
        ...
        mRecyclerview.setAdapter(mAdapter = new HeadFootAdapter<HeadView, ItemView, FootView>
                (this, 0, null, R.layout.item_item, mItemViews, R.layout.item_foot, mFootViews) {
            @Override
    ...
    private void initDatas() {
        ...
        for (int i=0;i<1;i++){
            mFootViews.add(new FootView("上拉加载更多..."));
            //"正在加载更多数据..."
        }
    }
